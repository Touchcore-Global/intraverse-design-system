...
const styles: Record<Variant, { bg: string; border: string; icon: React.ElementType; iconColor: string }> = {
  info: { bg: "bg-accent", border: "border-l-[hsl(var(--brand-blue))]", icon: Info, iconColor: "text-[hsl(var(--brand-blue))]" },
  warning: { bg: "bg-iv-orange-100", border: "border-l-amber-500", icon: AlertTriangle, iconColor: "text-amber-600" },
  danger: { bg: "bg-destructive/10", border: "border-l-red-500", icon: AlertOctagon, iconColor: "text-red-600" },
};
