        ...
        <div className="w-full max-w-md mx-4">
          <div className="bg-card rounded-xl shadow-lg border border-border p-8">
            ...
            {tab === "signin" ? (
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  ...
                  <select className="w-full h-10 px-3 rounded-lg border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary">
            ...
            <div className="flex gap-3">
              <button className="flex-1 h-10 rounded-lg border border-border bg-background text-sm font-medium hover:bg-accent transition-colors flex items-center justify-center gap-2">
