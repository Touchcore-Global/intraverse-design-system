    ...
    cards: [
      {
        ...
        description: "Search across Amadeus, Sabre, Galileo, NDC connections, consolidators, and aggregators simultaneously. One search returns all available fares so you never miss the best price.",
