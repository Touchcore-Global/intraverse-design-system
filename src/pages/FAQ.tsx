...
const categories: FAQCategory[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Intraverse has been building travel technology and serving the Nigerian travel market for several years. We've grown from a small team with a single product to a full-suite platform powering 200+ travel businesses across the country.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Travx is available for $100 per month. This includes your branded website, hosting, maintenance, booking engine integration, payment processing, and ongoing updates. There are no setup fees and no hidden charges.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "How much does Travx cost?",
        a: "Travx is $100 per month. This includes your branded website, hosting, booking engine, payment integration, and ongoing maintenance. There are no setup fees or hidden charges.",
      },
      {
        q: "How is CoopX priced?",
