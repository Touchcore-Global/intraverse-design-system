...
const STATIC_ROUTES = [
  ...
  { path: "/help/getting-started", changefreq: "monthly", priority: 0.5 },
  { path: "/help/booking-flights", changefreq: "monthly", priority: 0.5 },
  { path: "/help/hotels-tours", changefreq: "monthly", priority: 0.5 },
  { path: "/help/payments-wallet", changefreq: "monthly", priority: 0.5 },
  { path: "/help/managing-customers", changefreq: "monthly", priority: 0.5 },
  { path: "/help/account-settings", changefreq: "monthly", priority: 0.5 },
  { path: "/help/travel-links-packages", changefreq: "monthly", priority: 0.5 },
  { path: "/help/reports-analytics", changefreq: "monthly", priority: 0.5 },
